...
about Surge XT, want to help in developing it further or if you come across any bugs or other issues.nd the VST3 or CLAP to their correct locations.
The factory patches and wavetables will also be automatically installed.
...
**Global Volume** controls the last gain stage before the output. You can choose to hard clip the global output either at
**+18 dBFS** (default) or **0 dBFS**. Right click the volume slider to access that choice.
