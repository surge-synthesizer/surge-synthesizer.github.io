...
The patch browser also supports program changes via MIDI, which you can learn more about [here](#program-change-messages).

### Load more patches

To directly load patches (.fxp), drop onto the Surge XT window.
...
Right-click the heart icon to display your **Favorites** list.
