...
| **pb_range_dn**        | Pitchbend depth down                                                                   | Set under Bend Depth in the UI        |
| **pb_range_up**        | Pitchbend depth up                                                                     | Set under Bend Depth in the UI        |
...
| **mpe_bend**      | MPE pitchbend                                        | Ranges from -1 to 1  |
| **mpe_bendrange** | MPE pitchbend range                                  | Set in the MPE menu  |
