...
The Formula modulator is a full-fledged Lua-enabled scriptable modulation source. Although this
modulator may not be as straightforward to use and understand as those listed above, in its complexity
