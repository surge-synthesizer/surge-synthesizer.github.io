...
| **pb**                 | Currenv value of Pitch Bend                                                            | Ranges from -1 to 1                   |
| **pb_range_dn**        | Pitch bend down range                                                                  | Set under Bend Depth in the UI        |
| **pb_range_up**        | Pitch bend up range                                                                    | Set under Bend Depth in the UI        |
