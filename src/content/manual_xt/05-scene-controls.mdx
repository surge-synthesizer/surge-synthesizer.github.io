...
To scale the amplitude envelope, move the **VCA Gain** slider.
...
After passing through attack and decay stages, the envelope will stays in the sustain
stage until you release the note.

To temp sync any envelope stage, right-click then select *Tempo Sync**, or **Tempo Sync For All ... EG Parameters**
