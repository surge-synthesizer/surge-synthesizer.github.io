...
**Hint**: The Filter Analysis displays the frequency response of a filter.
...
To control how much the pitch of a note affects the cutoff frequency of a filter, move the **Keytrack** \> **F1/F2** sliders. A setting of 100% means the filter frequency will follow the pitch harmonically.
