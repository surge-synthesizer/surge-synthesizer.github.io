...
To route the scene output to send effect units, move the **Send FX ... Level** sliders. To display sends 3 and 4, select one of those FX units in the [Effect Unit Selector](#effect-unit-selector).
