...
- To change the curves of **Digital** envelopes, select or drag to move the highlight on the envelope graph, or right-click and select an option from the context menu. Depending on the stage, options **Convex**, **Linear**, **Quadratic**, and **Concave** are available.
