...
A waveshaper transforms each sample through a graph (shaping function). For example, a **Saturator** pushes sample values away from 0 and towards the outer limits of the wave.
