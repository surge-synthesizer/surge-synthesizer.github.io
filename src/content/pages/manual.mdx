...
For Surge XT manual, [please click here!](/manual-xt)
...
If you put user content in the factory folder or otherwise change it, future installers
will erase it. Surge's installers never touch anything in the user area.
...
![Illustration 1: The four sections the user-interface that Surge is divided into.](/images/manual/Pictures/sections.png)
...
![Illustration 2: Both scenes and all effect settings are stored in every patch.](/images/manual/Pictures/illu2.png)
...
![Illustration 5: Slider context menu](/images/manual/Pictures/slider_context_menu.png)
...
## Scene Select and Scene Mode ![](/images/manual/Pictures/scene_select.png)
...
![Illustration 3: The patch browser](/images/manual/Pictures/illu3.png)
...
![Illustration 10: ADSR envelope structure](/images/manual/Pictures/illu10.png)
...
Alternatively, routing mode can also be engaged or disengaged by pressing **TAB**
on the keyboard, or by pressing the **middle**, **previous**, or **next** mouse buttons
...
modulated and by which source.](/images/manual/Pictures/illu7.png)
...
used](/images/manual/Pictures/mod_source_buttons.png)
...
On the other hand, a scene modulator has one identical modulation path _for the whole scene_, so it can control both scene level parameters **and** voice level parameters.

![](/images/manual/Pictures/modsource_labels.png)

_On top, three voice LFOs. On the bottom, three Scene LFOs, "S-" meaning Scene._

To demonstrate this distinction, let's say an sine wave LFO is modulating the cutoff
of a filter. Now, if 3 notes are being hit with a small delay between each of them,
the phase of the LFO will be delayed between the notes accordingly.
...
![](/images/manual/Pictures/lfo_shapes.png)
...
![Illustration 12: 6-stage DAHDSR envelope](/images/manual/Pictures/illu12.png)
...
![Illustration 13: Step Seq editor](/images/manual/Pictures/stepseq.png)
...
![Illustration 14: Envelope retrigger pane of LFO 1](/images/manual/Pictures/illu14.png)
...
|**Negative deform**| ![](/images/manual/Pictures/stepseq_deform1.png)|
|**Positive deform**| ![](/images/manual/Pictures/stepseq_deform2.png)|

![Illustration 15: Effect of the deform parameter on the step Seq waveform](/images/manual/Pictures/illu15.png)
...
![Illustration 18: The effect block](/images/manual/Pictures/illu18.png)
...
Although Surge doesn't officially have touch screen support, setting mouse movement to _Exact_ and enabling
_Show mouse cursor while editing_ is likely to give you the best experience when interacting with Surge with a touch screen.
...
![Illustration 16: Block diagram of the synthesizer engine.](/images/manual/Pictures/illu16.png)

_Block diagram of the synthesizer engine._

![Illustration](/images/manual/Pictures/signal_flow.png)

Illustration shows an overview of the synthesizer engine of Surge.

### Voices

![Illustration 17: Block diagram of a synthesizer voice](/images/manual/Pictures/illu17.png)
...
![Illustration 19: Modulation routing behind the scenes](/images/manual/Pictures/illu19.png)
...
There is a reference for the .wt file-format used by the wavetables. It is located
at: `surgedata/wavetables/wt fileformat.txt`
...
![FM2 modulation matrix](/images/manual/Pictures/FM2.png)
...
![FM3 modulation matrix](/images/manual/Pictures/FM3.png)
...
**12 dB** - 2-Pole filter. Available in **Lowpass**, **Highpass**, **Bandpass** and
**Notch** types.
...
![Illustration 21: Distortion algorithm block diagram](/images/manual/Pictures/tech_distortion.png)

_Illustration 21: Distortion algorithm block diagram_
...
<sup>**1**</sup> For more information on the diode model used by the ring modulator, you can read [this
paper](http://dafx.de/paper-archive/2011/Papers/66_e.pdf).
...
<sup>**1**</sup> Once deactivated, the **Rate** parameter acts like a phase parameter, which can be scrubbed
...
![Illustration 20: Delay algorithm block diagram](/images/manual/Pictures/illu20.png)

_Illustration 20: Delay algorithm block diagram_
...
-   Middle note where the first entry in the mapping is mapped to: 60
-   Reference note for which frequency is given: 69
-   Frequency to tune the above note to (floating point e.g. 440.0): 440.000000
-   Scale degree to consider as formal octave: 0

This would be typical for mapping intonation systems to Halberstadt keyboards, such
as 12-note Pythagorean, various forms of meantone tunings, and a range of other so-called
syntonic temperaments built upon chains (or cycles) of fifths, where the 1/1 starting
note should fall on C.60 (middle C), and the concert reference pitch on A.69 @ 440
Hz. With this KBM, all of the well known classical diatonic modes will fall on the
white keys of the controller, with sharps and flats on the black keys.
...
Up until version 1.9, Surge made the choice that modulations were _tuned_. This means that the frequency of an oscillator
...
Feel free to visit the Surge Synth Discord [here](https://discord.gg/spGANHw) if you have questions about Surge, want to help in developing it further or if you come across any bugs or other issues.
