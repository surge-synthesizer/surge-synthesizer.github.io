...
| Arturia                | Acid V                          | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Analog Lab Pro                  | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Augmented Brass                 | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Augmented Mallets               | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Augmented Piano                 | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Augmented Strings               | Virtual-Instrument                           | NO and DM                                    | Multi-channel tuning                     |
| Arturia                | Augmented Woodwings             | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Augmented Voices                | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Augmented Yangtze               | Virtual-Instrument                           | NO and DM                                    |                                          |
...
| Arturia                | Jup-8000 V                      | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | MiniBrute V 4                   | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Mini 4                          | Virtual-Instrument                           | NO and DM                                    |                                          |
...
| Arturia                | Pigments 4/5/6                  | Virtual-Instrument                           | NO and DM                                    | Multi-channel tuning (enable MPE)        |
| Arturia                | Prophet-5 V                     | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Prophet-VS V                    | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | Pure LoFi                       | Virtual-Instrument                           | NO and DM                                    |                                          |
| Arturia                | SEM V                           | Virtual-Instrument                           | NO and DM                                    |                                          |
...
| Arturia                | Synthx V                        | Virtual-Instrument                           | NO and DM                                    |                                          |
...
| Dan Trueman            | bitKlavier                      | Virtual-Instrument                           | NO and DM                                    |                                          |
| Dawesome               | Kult                            | Virtual-Instrument                           | NO and DM                                    |                                          |
| Dawesome               | Myth                            | Virtual-Instrument                           | NO and DM                                    |                                          |
| discoDSP               | Bliss                           | Virtual-Instrument                           | DM                                           | From version 2.9.1                       |
...
| Greg Recco             | Audible Planets                 | Virtual-Instrument                           | NO and DM                                    | Multi-channel tuning                     |
| HY-Plugins             | HY-Poly                         | Virtual-Instrument                           | DM                                           |                                          |
| Modartt                | Pianoteq                        | Virtual-Instrument                           | NO and DM                                    | Multi-channel tuning                     |
...
| Surge Synth Team       | Surge XT                        | Virtual-Instrument                           | NO and DM                                    | Multi-channel tuning                     |
...
| TAL                    | TAL-Pha                         | Virtual-Instrument                           | DM                                           |                                          |
...
| Xfer Records           | Serum 2                         | Virtual-Instrument                           | DM                                           |                                          |
