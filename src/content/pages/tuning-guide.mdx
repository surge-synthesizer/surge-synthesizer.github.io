...
<div class="overflow-x-scroll max-w-[calc(100vw_-_6rem)]">
...
![Illustration 2: Radial tuning editor](/images/tuning-guide/tuning_radial.png)
...
![Illustration 6: Tuning editor HTML export](/images/tuning-guide/tuning_html-1.png)
...
![Illustration 7: KBM drag & drop](/images/tuning-guide/tuning_html-2.png)

Below we can see that the 1/1 for Bohlen-Pierce is now mapped to MIDI Note A.69 at 440 Hz:

![Illustration 8: Tuning editor 1/1 mapping](/images/tuning-guide/tuning_html-3.png)
...
![Illustration 9: Raw SCL and KBM links](/images/tuning-guide/tuning_html-4.png)

Click the Interval Matrices link to view a modal rotation of the current tuning by scale degrees and interval steps.

![Illustration 10: Interval matrices link](/images/tuning-guide/tuning_html-5.png)
...
![Illustration 11: Surge XT tuning menu with "Apply Tuning After Modulation" selected](/images/tuning-guide/after_modulation.png)
...
![Illustration 12: Assigning modulation to scene pitch](/images/tuning-guide/scene_pitch.png)
...
![Illustration 13: Assigning modulation to oscillator pitch](/images/tuning-guide/osc_pitch.png)
...
![Illustration 14: Extending the oscillator pitch range](/images/tuning-guide/extend_range.png)
...
![Illustration 15: Assigning modulation to oscillator pitch 2](/images/tuning-guide/assign.png)

![Illustration 16: typing in the correct mod depth](/images/tuning-guide/typein.png)

![Illustration 17: typing in double the mod depth](/images/tuning-guide/assign_two_octaves.png)
...
![Illustration 18: The step sequencer popup while holding shift](/images/tuning-guide/steps_one_octave.png)

![Illustration 19: holding alt+shift](/images/tuning-guide/steps_two_octaves.png)
...
![Illustration 20: drawing a line](/images/tuning-guide/Draw_Lines_SEQ_Steps_1.png)

![Illustration 21: result of the line](/images/tuning-guide/Draw_Lines_SEQ_Steps_2.png)
...
![illustration 22: The bitwig CLAP directory, with the tuning claps](/images/tuning-guide/Tuning-Claps-1.png)
...
![Illustration 23: The EDN-M Tuning Clap, tuning the Organ instrument](/images/tuning-guide/Tuning-Claps-2.png)
...
![Illustration 24: ODDSound MTS-ESP master and the MTS-ESP Tuning Clap, tuning a group of instruments](/images/tuning-guide/Tuning-Claps-3.png)
