...
- Improve Scale Rotation page to contain a column for the octave interval, in order to match up with exported HTML
- Add the necessary macOS entitlements in order to make Surge as MTS-ESP source work on macOS 26
...
- Fixed a bug where in some cases E and F keys in virtual keyboard would be triggered alongside other played keys
