...
We plan to release Surge XT 1.3 sometime in Winter 2023. This changelog is up to date as of Dec 6, 2023, commit 60366dc
...
-   Standalone application now works in fullscreen mode - choose Enter Full Screen option from Zoom menu, or press F11, to try it out!
